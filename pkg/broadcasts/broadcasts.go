...
func (c *Broadcasts) CreateWifiBroadcast(ctx context.Context, siteId string, req *CreateWifiBroadcastRequest) (*CreateWifiBroadcastResponse, error) {
	path := fmt.Sprintf("/v1/sites/%s/wifi/broadcasts", siteId)
	var result CreateWifiBroadcastResponse
...
func (c *Broadcasts) GetWifiBroadcastDetails(ctx context.Context, wifiBroadcastId string, siteId string) (*GetWifiBroadcastDetailsResponse, error) {
	path := fmt.Sprintf("/v1/sites/%s/wifi/broadcasts/%s", wifiBroadcastId, siteId)
	var result GetWifiBroadcastDetailsResponse
...
func (c *Broadcasts) UpdateWifiBroadcast(ctx context.Context, wifiBroadcastId string, siteId string, req *UpdateWifiBroadcastRequest) (*UpdateWifiBroadcastResponse, error) {
	path := fmt.Sprintf("/v1/sites/%s/wifi/broadcasts/%s", wifiBroadcastId, siteId)
	var result UpdateWifiBroadcastResponse
