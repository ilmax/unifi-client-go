...
func (c *Clients) ExecuteClientAction(ctx context.Context, clientId string, siteId string, req any) (any, error) {
...
func (c *Clients) GetConnectedClientDetails(ctx context.Context, clientId string, siteId string) (any, error) {
